...
$txt['hooks_disabled'] = 'Wyณฑczony';
$txt['hooks_missing'] = 'Nie znaleziono';
$txt['hooks_no_hooks'] = 'Nie znaleziono ฟadnych ustawie๑ hak๓w.';
$txt['hooks_button_remove'] = 'Usu๑';
$txt['hooks_disable_instructions'] = 'Kliknij na ikonie statusu aby wณฑczyๆ lub wyณฑczyๆ hak';
$txt['hooks_disable_legend'] = 'Legenda';
$txt['hooks_disable_legend_exists'] = 'hak istnieje i jest aktywny';
$txt['hooks_disable_legend_disabled'] = 'hak istnieje, ale zostaณ wyณฑczony';
